...
public class ControladorLibros {
 private static final String NOMBRE_ARCHIVO = "libros.txt";
    ...
    public static ArrayList<Libro> obtener() throws FileNotFoundException, IOException {
    ...
    public static void marcarComoPrestado(String codigoLibro) throws IOException {
    ...
    public static void cambiarSignatura(String codigoLibro, String nuevaSignatura, String nuevaLocalizacion) throws IOException {
        ArrayList<Libro> libros = ControladorLibros.obtener();
        int indice = ControladorLibros.buscarPorCodigo(codigoLibro, libros);
        if (indice == -1) {
            return;
    ...
    public static void solicitarDatosParaCambiarSignatura() throws IOException {
        Scanner sc = new Scanner(System.in);
    ...
    public static Libro imprimirLibrosYPedirSeleccion() throws IOException {
        ArrayList<Libro> libros = ControladorLibros.obtener();
        Scanner sc = new Scanner(System.in);
        while (true) {
